    ...
    var body: some View {
        TabView {
            Form {
                ...
                Section(header: Text("Calculated Drops")) {
                    HStack {
                        Text("Calcium:")
                        Spacer()
                        if unit == .milliliter {
            ...
            Form {
                Section {
                    ...
                    Text("Lotus Water ships with two types of droppers: \n**•Round Tipped**\n**•Straight Tipped**\n\nPlease configure your droppers above for accurate recipes.")
                        .font(.footnote)
                        .foregroundColor(.secondary)
                }
            }
