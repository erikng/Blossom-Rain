...
pluginManagement {
    ...
    if (System.getenv("BUILT_PRODUCTS_DIR") == null) {
        // System.setProperty("BUILT_PRODUCTS_DIR", "${System.getProperty("user.home")}/Users/erikgomez/Library/Developer/Xcode/DerivedData/BlossomRain-dknabfwgmqrtiaehxrltoxzvecdq/Build/Products/Debug-iphonesimulator")
    }
